...
namespace MemeApp.API.Migrations
{
    ...
    [Migration("20201201214756_blocks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemeApp.API.Models.Block", b =>
                {
            ...
            modelBuilder.Entity("MemeApp.API.Models.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MemeApp.API.Models.ReplyLike", b =>
                {
                    b.Property<int>("LikerId");
            ...
            modelBuilder.Entity("MemeApp.API.Models.Block", b =>
                {
                    b.HasOne("MemeApp.API.Models.User", "Blockee")
                        .WithMany("Blockers")
                        .HasForeignKey("BlockeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MemeApp.API.Models.User", "Blocker")
                        .WithMany("Blockees")
